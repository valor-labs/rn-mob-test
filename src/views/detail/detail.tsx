...
import { Container, H1, Text, H2, Footer, Button, Content, Header } from 'native-base';
    ...
    return (
        <Container>
            ...
            >
                ...
                <Text style={{ marginBottom: 24 }}>
                    Few markets and shops are located inside the compound. The security situation in the area is mostly
                    calm but guests have to check with the security unit if they want to venture outside.
                </Text>
                <Line />
            </Content>
            <Footer
